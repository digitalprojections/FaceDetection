    ...
    internal class Capture : ISampleGrabberCB, IDisposable
    {
            ...
            try
            {
                ...
                if (m_pinStill == null)
                {
                    ...
                    try
                    {
                        ...
                        // Find the CAPTURE pin from the video device and the
                        ...
                        pCaptureOut = DsFindPin.ByName(iSmartTee, "Preview");
                        m_pinStill = DsFindPin.ByName(iSmartTee, "Capture");
        ...
        int ISampleGrabberCB.BufferCB( double SampleTime, IntPtr pBuffer, int BufferLen )
        {
            ...
            if (m_WantOne)
            {
                ...
                //Debug.WriteLine(pBuffer + " " + BufferLen);
                // Save the buffer
